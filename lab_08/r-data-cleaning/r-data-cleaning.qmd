...
I would use the mutate function within tidyverse to make sure all of my information is correct regarding the state names. You could convert all of the state names to either lowercase or uppercase letters. I would do this so when I group the data, specifically, by state, it all transfers over and combines rows that have the same state. 
