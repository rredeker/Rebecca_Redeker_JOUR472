...
1. Is there a correlation between the percentage of upper level educated (associates or above) individuals in a county, and the support for each Republican/Democratic candidate in the primary election?

2. Do counties with higher median incomes tend to favor certain candidates over others in the primary election? 
